...
```bash
cd "c:/Users/site laptop2/Desktop/RSSMCP Sonyeni/RSSMCP"
...
```markdown
![GitHub stars](https://img.shields.io/github/stars/YOUR_USERNAME/RSS-MCP?style=social)
![GitHub forks](https://img.shields.io/github/forks/YOUR_USERNAME/RSS-MCP?style=social)
![GitHub issues](https://img.shields.io/github/issues/YOUR_USERNAME/RSS-MCP)
![GitHub last commit](https://img.shields.io/github/last-commit/YOUR_USERNAME/RSS-MCP)
```
